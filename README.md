...
`src/main/ssr_dynamic_routing/client.cljs` contains the code to start and refresh
...
application `ssr-dynamic-routing.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/ssr_dynamic_routing.jar
```
